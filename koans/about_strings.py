...
class AboutStrings(Koan):
    ...
    def test_single_quoted_strings_are_also_strings(self):
        ...
        self.assertEqual(True, isinstance(string, str))
    # https://docs.python.org/3/library/re.html?highlight=string%20quotes
    ...
    # https://docs.python.org/3/howto/regex.html?highlight=backslash
    # backslash can be used for escaping quotes
