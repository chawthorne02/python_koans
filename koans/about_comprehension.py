...
# https://docs.python.org/3/search.html?q=list+comprehension&check_keywords=yes&area=default
# A compact way to process all or part of the elements in a sequence and return a list with the results.
    ...
    def test_unpacking_tuples_in_list_comprehensions(self):
        ...
        self.assertEqual('lumberjack', comprehension[0]) #get the item based off what index the item is in
        self.assertEqual('spamspamspamspam', comprehension[2]) # gets the string and multiplies by the int which gives you "spamspamspamspam"
    ...
    def test_creating_a_set_with_set_comprehension(self):
        ...
        self.assertEqual({'c','a', 'b'}, comprehension)  # remember that set members are unique
