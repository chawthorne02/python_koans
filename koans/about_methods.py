...
# properties of the object that are defined by the attributes and behavior is defined using methods. Methods are defined in a class
...
# The purpose of the class methods is to set or get the details (status) of the class. They can’t access or modify specific instance data. They are bound to the class instead of their objects. 

# Static methods cannot access the class data. In other words, they do not need to access the class data. They are self-sufficient and can work on their own.
