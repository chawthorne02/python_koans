...
class AboutListAssignments(Koan):
    ...
    # https://docs.python.org/3/library/array.html?highlight=array%20assignments
    # When multiple variables are assigned to a list they take on the items in the list based on their corresponding value
