...
class AboutSets(Koan):
    def test_sets_make_keep_lists_unique(self):
        ...
        self.assertEqual({'Matunas', 'Ramirez', 'Malcolm', 'MacLeod'}
, there_can_only_be_only_one)
    ...
    def test_creating_sets_using_strings(self):
        ...
        self.assertEqual({'3', '4', '5', '2', '1'}, set('12345'))
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'Wallace', 'MacLeod', 'Leonidas', 'Willie'}, scotsmen | warriors)
