...
class AboutLists(Koan):
    ...
    def test_accessing_list_elements(self):
        ...
        # when the index is -1 it starts in the end of the list
    ...
    # Similar to an array JS that holds a list of items
    # negative intergers means you start from the end of the list
    ...
    #https://docs.python.org/3/library/array.html?highlight=insert#array.array.insert
    # Insert method inserts a new item in an array
    ...
    # The Pop method removes the item with the index i from the array and returns it.
